...
if(isset($_POST['submit'])){
  ...
  if($uname != '' || $pass != '' || $cpass != ''){
    if($pass == $cpass){
      $query = mysqli_query($conn , "INSERT INTO users (username, password) values ('$uname', '$pass')");
      if($query){
...
<form action="" method="post">
  ...
  <div class="form-group">
      ...
      <input type="password" class="form-control" name ="conpassword" id="inputPassword" placeholder="Confirm Password" require>
    </div>
  <div class="form-group">
